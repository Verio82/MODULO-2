// Servidor TCP para chat usando MVC

const net = require('net');
const controlador = require('./controladores/mensajeControlador');
...
const server = net.createServer((socket) => {
  ...
  sendResponse({
    ok: true,
    message: 'Conectado al servidor de chat. Comandos: enviar <usuario> <mensaje>, listar'
  });
